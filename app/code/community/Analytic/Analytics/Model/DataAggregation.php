...
/**
 * Analytics Data Aggregation Model
 *
 * @property Analytic_Analytics_Model_Resource_DataAggregation $_resource
 * @method Analytic_Analytics_Model_Resource_DataAggregation getResource()
 * @method Analytic_Analytics_Model_Resource_DataAggregation _getResource()
 */
class Analytic_Analytics_Model_DataAggregation extends Mage_Core_Model_Abstract
{
    ...
    const XML_DOWN_CRON_FINISH_FLAG         = 'analytic/down_cron_finished';
    ...
    {
        $this->_init('analytic/dataAggregation');
    ...
    public function parseDataCronJob($config = array('goToDown' => false))
    {
        ...
        try {
            ...
            if ((isset($config['dateStart']) && isset($config['dateEnd'])) || $config['goToDown']) {
                /* @var $processor Analytic_Analytics_Model_DailyAggregation */
                $processor = Mage::getModel('analytic/dailyAggregation');
