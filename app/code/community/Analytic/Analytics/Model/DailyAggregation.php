...
class Analytic_Analytics_Model_DailyAggregation extends Mage_Core_Model_Abstract
{
    ...
    /**
     * @var Analytic_Analytics_Model_Resource_DailyAggregation
     */
    private $resource;
    ...
    {
        $this->_init('analytic/dailyAggregation');
