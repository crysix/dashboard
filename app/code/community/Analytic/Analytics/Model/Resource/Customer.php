...
class Analytic_Analytics_Model_Resource_Customer extends Analytic_Analytics_Model_Resource_Base
{
    /**
    ...
    {
        $this->_init('analytic/customer', 'id');
    }
    ...
    public function getNewVisitorsGroupData($dateFrom, $dateTo, $groupType, Mage_Eav_Model_Entity_Attribute_Abstract $attribute, $storeId = null, $limit = null, $whereValues = array())
    {
        ...
        $select = $adapter->select()
            ...
            ->where('(customer.is_new_customer = 1 OR analytic.customer_id is NULL)')
            ->where('analytic.period > :dateFrom')
            ->where('analytic.period <= :dateTo');
    ...
    public function getNewVisitorsData($dateFrom, $dateTo, $storeId = null, $limit = null, $sort = null, $whereValues = array())
    {
        ...
        $this->_select->where('(is_new_customer = 1 OR analytic.customer_id is NULL)');
