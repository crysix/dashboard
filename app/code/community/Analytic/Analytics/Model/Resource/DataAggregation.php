...
class Analytic_Analytics_Model_Resource_DataAggregation extends Analytic_Analytics_Model_Resource_Base
{
    /**
    ...
    {
        $this->_init('analytic/dataAggregation', 'id');
    }
    ...
    public function getIfDateAggregated($periodStart)
    {
        return $this->_getReadAdapter()->select()
            ->from($this->getTable('analytic/cron_job'), 'id')
    ...
    {
        return $this->_getReadAdapter()->select()
            ->from($this->getTable('analytic/cron_job'), 'COUNT(*)')
            ->where('date_time >= ?', $periodStart)
    ...
    public function getDbTime($isGoDown = false)
    {
        ...
        $select = $adapter->select()
            ->from($this->getTable('analytic/cron_job'), $column)
    ...
    {
        $this->_getWriteAdapter()->insert($this->getTable("analytic/cron_job"), array(
    ...
    public function saveCreatedOrdersData($userOrder, $periodStart, $periodEnd)
    {
        ...
        $modelRecord = $this->getRecordFromDb(
            'analytic/shop',
            array(array('name' => 'analytic_id', 'filter' => array('eq' => $analyticId))),
            array('analytic_id' => $analyticId)
        );
    ...
    {
        $this->_getWriteAdapter()->insert($this->getTable('analytic/product'), array(
            'analytic_id' => $this->getAnalyticId(
                $product['customer_id'],
                $product['store_id'],
                $periodStart,
    ...
    {
        $this->_getWriteAdapter()->insert($this->getTable('analytic/page'), array(
            'analytic_id' => $this->getAnalyticId(
    ...
    {
        $this->_getWriteAdapter()->insert($this->getTable('analytic/refer'), array(
            'analytic_id' => $this->getAnalyticId(
                $refer['customer_id'],
                $refer['store_id'],
                $periodStart,
    ...
    {
        $this->_getWriteAdapter()->insertOnDuplicate(
            $this->getTable('analytic/customer'),
            array(
                'analytic_id' => $this->getAnalyticId(
    ...
    {
        $this->_getWriteAdapter()->insertOnDuplicate(
            $this->getTable('analytic/visitor'),
            array(
                 'analytic_id' => $this->getAnalyticId(
                     $visitor['customer_id'],
                     $visitor['store_id'],
    ...
    public function getAnalyticId($customerId, $storeId, $periodStart, $periodEnd)
    {
        ...
        $tableName = $this->getTable('analytic/data');
