...
class Analytic_Dashboard_Block_Adminhtml_Userdashboard_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_updateButton('back', 'label', Mage::helper('analytic_dashboard')->__('Cancel'));
    ...
    public function getDashboard()
    {
        ...
        $dashboard = Mage::getModel('analytic_dashboard/dashboard')->load($id);
