...
class Analytic_Dashboard_Block_Adminhtml_Userdashboard_Widget_Bar extends Analytic_Dashboard_Block_Adminhtml_Userdashboard_Widget_Abstract
{
    /**
     * @var array
     */
    ...
    {
        $this->setTemplate('analytic_dashboard/widget/bar.phtml');
