...
class Analytic_Dashboard_Block_Adminhtml_Userdashboard_Widget_Table extends Analytic_Dashboard_Block_Adminhtml_Userdashboard_Widget_Abstract
{
    ...
    {
        $this->setTemplate('analytic_dashboard/widget/table.phtml');
    ...
    public function getGroupedByAttributeLabel()
    {
        ...
        return $this->helper("analytic_dashboard")->getAttributeData($this->getGroupedByAttribute())->getAttribute()->getStoreLabel();
    }
