...
class Analytic_Dashboard_Block_Adminhtml_Userdashboard_Widget_Abstract extends Mage_Adminhtml_Block_Template
{
     ...
     * Get widget
     *
     * @return Analytic_Dashboard_Model_Widget || Varien_Object
     */
