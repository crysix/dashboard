...
class Analytic_Dashboard_Block_Adminhtml_Dashboard_Edit_Grid_Users extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     ...
     * @return Analytic_Dashboard_Block_Adminhtml_Dashboard_Edit_Grid_Users
     */
    ...
    protected function _getSelectedUsers($type, $json = false)
    {
        ...
        $users = Mage::getModel('analytic_dashboard/user')->getUserIds($dashboardId, $type, 1);
        if (sizeof($users) > 0) {
            if ($json) {
                $jsonUsers = Array();
