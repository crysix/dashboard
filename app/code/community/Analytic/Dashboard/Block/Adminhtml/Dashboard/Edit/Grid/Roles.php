...
class Analytic_Dashboard_Block_Adminhtml_Dashboard_Edit_Grid_Roles extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
    ...
    protected function _prepareColumns()
    {
        $this->addColumn('view', array(
            ...
            'renderer' => 'analytic_dashboard/adminhtml_dashboard_edit_grid_widget_renderer_checkbox'
        ));
     ...
     * @return Analytic_Dashboard_Block_Adminhtml_Dashboard_Edit_Grid_Roles
     */
    ...
    protected function _getSelectedRoles($type, $json = false)
    {
        ...
        $roles = Mage::getModel('analytic_dashboard/role')->getRoleIds($dashboardId, $type, 1);
        if (sizeof($roles) > 0) {
            if ($json) {
                $jsonRoles = Array();
