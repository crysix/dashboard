...
class Analytic_Dashboard_Model_Metric_NumberOfNewCustomers extends Analytic_Dashboard_Model_Metric_Abstract
{
    protected $_code = 'number_of_new_customers';
    ...
    {
        $value = $this->getModel($this->modelName)->getNewCustomersCount(
    ...
    {
        return $this->getModel($this->modelName)->getNewCustomersData(
            Mage::helper('analytic_dashboard')->getDateFrom(true),
            Mage::helper('analytic_dashboard')->getDateTo(true),
            Mage::helper('analytic_dashboard')->getStore(),
            $limit,
    ...
    {
        return $this->getModel($this->modelName)->getNewCustomersGroupData(
            Mage::helper('analytic_dashboard')->getDateFrom(true),
            Mage::helper('analytic_dashboard')->getDateTo(true),
    ...
    {
        return $this->round($this->getModel($this->modelName)->getNewCustomersAvgCount(
            Mage::helper('analytic_dashboard')->getDateFrom(true),
            Mage::helper('analytic_dashboard')->getDateTo(true),
            Mage::helper('analytic_dashboard')->getStore()
        ));
