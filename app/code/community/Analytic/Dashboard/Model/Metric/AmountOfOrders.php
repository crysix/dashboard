...
class Analytic_Dashboard_Model_Metric_AmountOfOrders extends Analytic_Dashboard_Model_Metric_Abstract
{
    protected $_code = 'amount_of_orders';
    ...
    {
        return $this->getModel($this->modelName)->getOrdersAmountCount(
    ...
    {
        return $this->getModel($this->modelName)->getOrdersAmountData(
            Mage::helper('analytic_dashboard')->getDateFrom(true),
            Mage::helper('analytic_dashboard')->getDateTo(true),
            Mage::helper('analytic_dashboard')->getStore(),
            $limit,
    ...
    {
        return $this->getModel($this->modelName)->getOrdersAmountGroupData(
            Mage::helper('analytic_dashboard')->getDateFrom(true),
            Mage::helper('analytic_dashboard')->getDateTo(true),
    ...
    {
        return $this->round($this->getModel($this->modelName)->getOrdersAmountAvgCount(
            Mage::helper('analytic_dashboard')->getDateFrom(true),
            Mage::helper('analytic_dashboard')->getDateTo(true),
            Mage::helper('analytic_dashboard')->getStore()
        ));
