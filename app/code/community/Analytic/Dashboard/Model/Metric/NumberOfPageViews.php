...
class Analytic_Dashboard_Model_Metric_NumberOfPageViews extends Analytic_Dashboard_Model_Metric_Abstract
{
    /**
     * @var string
     */
    protected $_code = 'number_of_page_views';
    private $modelName = 'analytic/page';
    ...
    {
        return $this->getModel($this->modelName)->getPageViewsCount(
    ...
    {
        return $this->getModel($this->modelName)->getPageViewsData(
            Mage::helper('analytic_dashboard')->getDateFrom(true),
            Mage::helper('analytic_dashboard')->getDateTo(true),
            Mage::helper('analytic_dashboard')->getStore(),
            $limit,
    ...
    {
        return $this->getModel($this->modelName)->getPageViewsGroupData(
            Mage::helper('analytic_dashboard')->getDateFrom(true),
            Mage::helper('analytic_dashboard')->getDateTo(true),
    ...
    {
        return $this->round($this->getModel($this->modelName)->getPageViewsAvgCount(
            Mage::helper('analytic_dashboard')->getDateFrom(true),
            Mage::helper('analytic_dashboard')->getDateTo(true),
            Mage::helper('analytic_dashboard')->getStore()
        ));
