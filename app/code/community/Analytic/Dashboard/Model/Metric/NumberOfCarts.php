...
class Analytic_Dashboard_Model_Metric_NumberOfCarts extends Analytic_Dashboard_Model_Metric_Abstract
{
    protected $_code = 'number_of_carts';
    ...
    {
        return $this->getModel($this->modelName)->getCartsCount(
    ...
    {
        return $this->getModel($this->modelName)->getCartsData(
            Mage::helper('analytic_dashboard')->getDateFrom(true),
            Mage::helper('analytic_dashboard')->getDateTo(true),
            Mage::helper('analytic_dashboard')->getStore(),
            $limit,
    ...
    {
        return $this->getModel($this->modelName)->getCartsGroupData(
            Mage::helper('analytic_dashboard')->getDateFrom(true),
            Mage::helper('analytic_dashboard')->getDateTo(true),
    ...
    {
        return $this->round($this->getModel($this->modelName)->getCartsAvgCount(
            Mage::helper('analytic_dashboard')->getDateFrom(true),
            Mage::helper('analytic_dashboard')->getDateTo(true),
            Mage::helper('analytic_dashboard')->getStore()
        ));
