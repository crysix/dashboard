...
class Analytic_Dashboard_Model_Metric_NumberOfCheckouts extends Analytic_Dashboard_Model_Metric_Abstract
{
    protected $_code = 'number_of_checkouts';
    ...
    {
        return $this->getModel($this->modelName)->getCheckoutsCount(
    ...
    {
        return $this->getModel($this->modelName)->getCheckoutsData(
            Mage::helper('analytic_dashboard')->getDateFrom(true),
            Mage::helper('analytic_dashboard')->getDateTo(true),
            Mage::helper('analytic_dashboard')->getStore(),
            $limit,
    ...
    {
        return $this->getModel($this->modelName)->getCheckoutsGroupData(
            Mage::helper('analytic_dashboard')->getDateFrom(true),
            Mage::helper('analytic_dashboard')->getDateTo(true),
    ...
    {
        return $this->round($this->getModel($this->modelName)->getCheckoutsAvgCount(
            Mage::helper('analytic_dashboard')->getDateFrom(true),
            Mage::helper('analytic_dashboard')->getDateTo(true),
            Mage::helper('analytic_dashboard')->getStore()
        ));
