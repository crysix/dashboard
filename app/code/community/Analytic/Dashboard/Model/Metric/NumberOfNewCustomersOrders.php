...
class Analytic_Dashboard_Model_Metric_NumberOfNewCustomersOrders extends Analytic_Dashboard_Model_Metric_Abstract
{
    ...
    {
        return $this->getModel($this->modelName)->getNewCustomersOrdersCount(
    ...
    {
        return $this->getModel($this->modelName)->getNewCustomersOrdersData(
            Mage::helper('analytic_dashboard')->getDateFrom(true),
            Mage::helper('analytic_dashboard')->getDateTo(true),
            Mage::helper('analytic_dashboard')->getStore(),
            $limit,
    ...
    {
        return $this->getModel($this->modelName)->getNewCustomersOrdersGroupData(
            Mage::helper('analytic_dashboard')->getDateFrom(true),
            Mage::helper('analytic_dashboard')->getDateTo(true),
    ...
    {
        return $this->round($this->getModel($this->modelName)->getNewCustomersOrdersAvgCount(
            Mage::helper('analytic_dashboard')->getDateFrom(true),
            Mage::helper('analytic_dashboard')->getDateTo(true),
            Mage::helper('analytic_dashboard')->getStore()
        ));
