...
class Analytic_Dashboard_Model_Resource_User extends Mage_Core_Model_Resource_Db_Abstract
{
    /**
    ...
    {
        $this->_init('analytic_dashboard/permissions_user', 'id');
    }
    ...
    public function getDefaultDashboardId($userId)
    {
        ...
        $select = $adapter->select()
            ->from(array("main_table" => $this->getTable("analytic_dashboard/dashboard")), "main_table.id")
            ->joinLeft(
            array("dashboard_users" => $this->getTable("analytic_dashboard/permissions_user")),
            ...
            array("dashboard_roles" => $this->getTable("analytic_dashboard/permissions_role")),
