...
class Analytic_Dashboard_Model_Resource_Widget extends Mage_Core_Model_Resource_Db_Abstract
{
    /**
    ...
    {
        $this->_init('analytic_dashboard/widget', 'id');
     ...
     * @param  int                                 $dashboardId
     * @return Analytic_Dashboard_Model_Resource_Widget
     */
